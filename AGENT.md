...
- **Existing Chart Menu** (canvas right-click with chart loaded): Reset Chart, Reset Drawings, Clear Canvas; South Indian: Set as Lagna; North Indian: Set Lagna as… (zodiac submenu on desktop, flat rashi list on mobile)
...
- **South Indian Lagna**: Right-click a bhava → **Set as Lagna (Ascendant)**; or use chart menu → Set as Lagna. House menu header shows **House N** counted from Lagna (not fixed grid position)
